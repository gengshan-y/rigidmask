...
def dataloader(filepath):
  ...
  #l0_train = sorted([impath for impath in l0_train if  (('alley_2' in impath))])
  l0_train = sorted([impath for impath in l0_train if  (('alley_2' in impath) or ('temple_2' in impath) or ('market_5' in impath) or ('ambush_6' in impath) or ('cave_4' in impath) )])
