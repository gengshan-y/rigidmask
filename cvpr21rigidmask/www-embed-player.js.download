...
var la=ka(this);function u(a,b){if(b){for(var c=la,d=a.split("."),e=0;e<d.length-1;e++){var f=d[e];f in c||(c[f]={});c=c[f]}d=d[d.length-1];e=c[d];f=b(e);f!=e&&null!=f&&ja(c,d,{configurable:!0,writable:!0,value:f})}}
...
var Fa="closure_uid_"+(1E9*Math.random()>>>0),Ga=0;function Ia(a,b,c){return a.call.apply(a.bind,arguments)}
...
function b(p){for(var v=g,r=0;64>r;r+=4)v[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=v[r-3]^v[r-8]^v[r-14]^v[r-16],v[r]=(p<<1|p>>>31)&4294967295;p=e[0];var B=e[1],K=e[2],ma=e[3],Oc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ha=ma^B&(K^ma);var Kb=1518500249}else Ha=B^K^ma,Kb=1859775393;else 60>r?(Ha=B&K|ma&(B|K),Kb=2400959708):(Ha=B^K^ma,Kb=3395469782);Ha=((p<<5|p>>>27)&4294967295)+Ha+Oc+Kb+v[r]&4294967295;Oc=ma;ma=K;K=(B<<30|B>>>2)&4294967295;B=p;p=Ha}e[0]=e[0]+p&4294967295;e[1]=
e[1]+B&4294967295;e[2]=e[2]+K&4294967295;e[3]=e[3]+ma&4294967295;e[4]=e[4]+Oc&4294967295}
...
;function Pc(a){var b=Kc(String(x.location.href)),c;(c=x.__SAPISID||x.__APISID||x.__OVERRIDE_SID)?c=!0:(c=new mc(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?x.__SAPISID:x.__APISID,c||(c=new mc(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(x.location.href);return d&&c&&b?[b,Mc(Kc(d),c,a||null)].join(" "):null}return null}
...
function eg(a){var b=void 0===a?{}:a;a=void 0===b.Ea?!0:b.Ea;b=void 0===b.Qa?!1:b.Qa;if(null==z("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?C()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&fg();W(document,"keydown",fg);W(document,"keyup",fg);W(document,"mousedown",fg);W(document,"mouseup",fg);a&&(b?W(window,"touchmove",function(){gg("touchmove",200)},{passive:!0}):(W(window,"resize",function(){gg("resize",200)}),W(window,"scroll",function(){gg("scroll",200)})));
...
function jg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:hg())};R("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,ig[b]=b in ig?ig[b]+1:0,a.sequence={index:ig[b],groupKey:b},d.sb&&delete ig[d.P]);(d=d.da)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),Ff[d.token]=a,d=Lf("log_event",d.token)):d=Lf("log_event");d.push(e);c&&(Af.log_event=new c);c=Je("web_logging_max_batch")||
...
function lg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.pb||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().ob:b=Pc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function ng(a,b,c,d){nc.set(""+a,b,{ma:c,path:"/",domain:void 0===d?"youtube.com":d,secure:!1})}
...
og.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=nc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
og.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;nc.remove(""+a,"/",void 0===b?"youtube.com":b)};var pg=new og;function qg(a,b,c,d){if(d)return null;d=pg.get("nextId",!0)||1;var e=pg.get("requests",!0)||{};e[d]={method:a,request:b,authState:mg(c),requestTime:Math.round(U())};pg.set("nextId",d+1,86400,!0);pg.set("requests",e,86400,!0);return d}
...
;function wg(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ba(q(c)))}
...
g)break}else if(a.hasOwnProperty("params"))if(e=a.params,"object"===typeof a.params)for(h in k=0,e){if(e[h]&&(g="params."+h,l=String(JSON.stringify(e[h])).substr(0,500),c[g]=l,k+=g.length+l.length,500<k))break}else c.params=String(JSON.stringify(e)).substr(0,500);a=oc(a);(f=f||a.stack)||(f="Not available");e={stackTrace:f};a.fileName&&(e.filename=a.fileName);h=a.lineNumber.toString();isNaN(h)||!b||isNaN(b)||(e.lineNumber=Number(h),e.columnNumber=Number(b),h=h+":"+b);window.yterr&&Ca(window.yterr)&&
(a.params=c,window.yterr(a));if(!(xg.has(a.message)||0<=f.indexOf("/YouTubeCenter.js")||0<=f.indexOf("/mytube.js"))){R("kevlar_gel_error_routing")&&(b=d,k={level:"ERROR_LEVEL_UNKNOWN"},"ERROR"===b?k.level="ERROR_LEVEL_ERROR":"WARNING"===b&&(k.level="ERROR_LEVEL_WARNNING"),ug("clientError",{errorMetadata:{pageUrl:window.location.href},stackTrace:{isObfuscated:!0,browserStackInfo:e},logMessage:k}),vg(),If());d={bb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:h,level:d,"client.name":c.name},
C:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};c.version&&(d["client.version"]=c.version);if(d.C){f&&(d.C.stack=f);f=q(Object.keys(c));for(b=f.next();!b.done;b=f.next())b=b.value,d.C["client."+b]=c[b];if(c=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=q(Object.keys(c)),b=f.next();!b.done;b=f.next())b=b.value,d.C[b]=c[b]}We(Q("ECATCHER_REPORT_HOST","")+"/error_204",d);xg.add(a.message);yg++}}}
...
y("yt_logging_screen.getCttAuthInfo",sh,void 0);function th(a,b,c,d){c=void 0===c?0:c;if(a!==Q(lh(c))||b!==Q(mh(c)))rh(a,d,c),P(lh(c),a),P(mh(c),b),0==c&&(b=function(){setTimeout(function(){a&&jg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:hh,clientScreenNonce:a},tg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
...
t(Ih,vh);var Eh=new wh("screen-created",Ih),Jh=[],Kh=0;function Lh(a,b,c){b={csn:a,parentVe:kh(b),childVes:Pa(c,function(e){return kh(e)})};
c=q(c);for(var d=c.next();!d.done;d=c.next())d=kh(d.value),($a(d)||!d.trackingParams&&!d.veType)&&Cg(Error("Child VE logged with no data"),"WARNING");c={da:sh(a),P:a};"UNDEFINED_CSN"==a?Mh("visualElementAttached",b,c):jg("visualElementAttached",b,tg,c)}
function Mh(a,b,c){Jh.push({Pa:a,payload:b,options:c});Kh||(Kh=Fh())}
function Gh(a){if(Jh){for(var b=q(Jh),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,jg(c.Pa,c.payload,null,c.options));Jh.length=0}Kh=0}
...
t(Oh,M);Oh.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.qb)}M.prototype.o.call(this)};var Ph=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Qh(a){a=a||"";if(window.spf){var b=a.match(Ph);spf.style.load(a,b?b[1]:"",void 0)}else Rh(a)}
...
a.K=!0;b?a.A():(Lg(bi(a),a.A),Qh(a.i?a.i.cssUrl:a.f.assets.css),ei(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
...
function Vh(a){a.w=!1;if(a.V)for(var b in a.j)a.V(b,a.j[b]);for(var c in a.S)T(parseInt(c,10));a.S={};a.D=null;a.V=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Z.bind(a);a.api.removeEventListener=a.Sa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ca.bind(a);a.api.getPlayerType=a.Da.bind(a);a.api.getCurrentVideoConfig=a.Ba.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.La.bind(a)}
...
n.Sa=function(a,b){if(!this.g){var c=Yh(this,b);c&&Wd(this.F,a,c)}};
...
Y.GetTrending_rid="mwebInfo.getTrendingRequestId",Y.GetMusicSearchSuggestions_rid="musicInfo.getMusicSearchSuggestionsRequestId",Y),Ki="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Li={},Mi=(Li.mver="MEASUREMENT_VERSION_",Li.pis="PLAYER_INITIALIZED_STATE_",Li.yt_pt=
"LATENCY_PLAYER_",Li.pa="LATENCY_ACTION_",Li.yt_vst="VIDEO_STREAM_TYPE_",Li),Ni="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");function Oi(a){return!!Q("FORCE_CSI_ON_GEL",!1)||R("csi_on_gel")||!!ui(a).useGel}
...
n.Ua=function(a,b){this.j&&!this.g&&aj(this.f,a,this.fa(a,b))};
...
gj.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function hj(){var a=this.g=new gj(!!Q("WIDGET_ID_ENFORCE")),b=A(this.Ra,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=hj.prototype;n.Ra=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,ij(this,a)),this.j[a]=!0)):this.na(a,b,c)};
n.na=function(){};
...
n.dispose=function(){this.g=null};function kj(a){hj.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.Oa,this));this.addEventListener("onVideoProgress",A(this.Ya,this));this.addEventListener("onVolumeChange",A(this.Za,this));this.addEventListener("onApiChange",A(this.Ta,this));this.addEventListener("onPlaybackQualityChange",A(this.Va,this));this.addEventListener("onPlaybackRateChange",A(this.Wa,this));this.addEventListener("onStateChange",A(this.Xa,this));this.addEventListener("onWebglSettingsChanged",A(this.ab,
this))}
...
n.Va=function(a){jj(this,{playbackQuality:a})};
n.Wa=function(a){jj(this,{playbackRate:a})};
...
n.Za=function(){jj(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());jj(this,a)};
n.ab=function(){var a={sphericalProperties:this.f.getSphericalProperties()};jj(this,a)};
...
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Aj(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=nc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
function Lj(a){var b=qh();a=Hj[a.id];if(b&&a){a={csn:b,ve:kh(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var c={da:sh(b),P:b};"UNDEFINED_CSN"==b?Mh("visualElementGestured",a,c):jg("visualElementGestured",a,tg,c)}}
function Mj(a){a=a.ids;var b=qh();if(b)for(var c=0;c<a.length;c++){var d=Hj[a[c]];if(d){var e=b;d={csn:e,ve:kh(d),eventType:1};var f={da:sh(e),P:e};"UNDEFINED_CSN"==e?Mh("visualElementShown",d,f):jg("visualElementShown",d,tg,f)}}}
...
c=Q("BG_P",void 0);ch(c)&&(Q("BG_I")||Q("BG_IU"))&&(Zg=!0,Yg.initialize(Q("BG_I",null),Q("BG_IU",null),c,bh,void 0));Ug()},void 0);
